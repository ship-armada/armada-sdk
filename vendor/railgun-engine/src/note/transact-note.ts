...
// DIVERGES FROM UPSTREAM: TokenDataGetter injected as a minimal interface (the concrete,
// contract-backed getter is above-core, not vendored); only the NFT decrypt/deserialize path uses it.
export interface TokenDataGetter {
...
import { TXIDVersion } from '../models/txid-version';
