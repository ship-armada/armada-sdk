...
// DIVERGES FROM UPSTREAM: UnshieldStoredEvent lifted here (event-types is above-core, not vendored);
// proof-of-innocence field dropped (SPEC §3.5).
type UnshieldStoredEvent = {
  txid: string;
